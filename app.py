...
with col2:
    ...
    uploaded_file = st.file_uploader(
        ...
        type=['csv'],
        help="Format: videoUrl, startTime, endTime, questionText"
    )
...
if uploaded_file:
    ...
    with col1:
        ...
        **1️⃣ Préparez votre CSV**
        - Colonnes: `videoUrl`, `startTime`, `endTime`, `questionText`
        - Temps en **secondes**
    ...
    with col2:
        ...
        ✅ Qualité 240p-480p optimisée  
        ✅ Gestion automatique erreurs  
        ✅ Rapport détaillé  
        ✅ Noms basés sur questions  
        ✅ ZIP téléchargeable  
        """)
    ...
    example = pd.DataFrame({
        'videoUrl': ['https://www.youtube.com/watch?v=abc123', 'https://youtu.be/xyz789'],
        'startTime': [25, 50],
        'endTime': [32, 60],
        'questionText': ['Which team?', 'What score?']
    })
    st.dataframe(example, use_container_width=True)

st.markdown("---")
st.markdown("<p style='text-align: center; color: gray;'>Made with ❤️ by Claude AI for Lyra | v1.0</p>", unsafe_allow_html=True)
```
...
2. Cliquez **"Sign up"** ou **"Sign in with GitHub"**
3. Autorisez Streamlit à accéder à GitHub
4. Cliquez **"New app"**
5. Remplissez:
   - **Repository:** `votre-username/youtube-video-cutter`
   - **Branch:** `main`
